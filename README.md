...
1. Clone and do `git subtree add --prefix=addons/ui_widget https://github.com/ThyMajesty/ui_widget.git addon --squash`(seems to be not needed as being autoresolved on clone) to init addon
